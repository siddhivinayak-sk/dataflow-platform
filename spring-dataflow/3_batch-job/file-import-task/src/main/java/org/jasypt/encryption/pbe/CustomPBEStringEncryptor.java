...
public final class CustomPBEStringEncryptor implements PBEStringCleanablePasswordEncryptor {

		Logger logger = Logger.getLogger(CustomPBEStringEncryptor.class.getName());
	    ...
	    StandardPBEStringEncryptor[] getPool() {
	    	return pool;
	    }
	     ...
	     */
	    public CustomPBEStringEncryptor() {
	        super();
	    ...
	    public void setKey(String myKey) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException, NoSuchPaddingException {
